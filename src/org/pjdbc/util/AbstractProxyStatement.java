...
public abstract class AbstractProxyStatement implements Statement {
    ...
    public ResultSet executeQuery (String sql) throws SQLException {return delegates.get(0).executeQuery(sql);}
    ...
    public boolean execute (String sql) throws SQLException {return delegates.get(0).execute(sql);}
    public boolean execute (String sql, String[] columnNames) throws SQLException {return delegates.get(0).execute(sql, columnNames);}
    public boolean execute (String sql, int autoGeneratedKeys) throws SQLException {return delegates.get(0).execute(sql, autoGeneratedKeys);}
    public boolean execute (String sql, int[] columnIndexes) throws SQLException {return delegates.get(0).execute(sql, columnIndexes);}
    ...
    public int executeUpdate (String sql) throws SQLException {return delegates.get(0).executeUpdate(sql);}
    public int executeUpdate (String sql, String[] columnNames) throws SQLException {return delegates.get(0).executeUpdate(sql, columnNames);}
    public int executeUpdate (String sql, int autoGeneratedKeys) throws SQLException {return delegates.get(0).executeUpdate(sql, autoGeneratedKeys);}
    public int executeUpdate (String sql, int[] columnIndexes) throws SQLException {return delegates.get(0).executeUpdate(sql, columnIndexes);}
    ...
    public int[] executeBatch () throws SQLException {return delegates.get(0).executeBatch();}
