...
public abstract class AbstractProxyConnection implements Connection {
    ...
    public AbstractProxyConnection (Connection conn, String url, Properties info) 
	throws SQLException {
	this.delegate = conn; this.url = url; this.info = info;}
	...
	throws SQLException {
	return new AbstractProxyStatement(this, delegate.createStatement(), url, info){};}

    public Statement createStatement (int resultSetType, int resultSetConcurrency) 
	throws SQLException {
	return new AbstractProxyStatement(this, delegate.createStatement(resultSetType, resultSetConcurrency), url, info){};}

    public Statement createStatement (int resultSetType, int resultSetConcurrency, int resultSetHoldability) 
	throws SQLException {
	return new AbstractProxyStatement(this, delegate.createStatement(resultSetType, resultSetConcurrency, resultSetHoldability), url, info){};}}
